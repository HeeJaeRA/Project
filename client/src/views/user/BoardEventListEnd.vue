<template>
	<div class="container">
		<br />
		<h4 style="font-family: JalnanGothic; margin-bottom: 40px">종료된 이벤트</h4>
		<br />
		<div>
			<p>
		...
		<div class="d-flex justify-content-center mt-3" v-if="this.endEventList[0] != null">
			<paginate
...
export default {
	...
	methods: {
		...
		async getEndEventList() {
			this.endEventList = (
				await axios.get(`/node/usereventpageend/${this.currentPage}`).catch((err) => console.log(err))
			).data;
		},
