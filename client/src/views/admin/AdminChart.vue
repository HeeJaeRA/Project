<template>
	<div>
		<div id="container" style="border: 1px solid #ccc; border-radius: 20px; height: 400px; margin: 20px">
		...
		<div style="border: 1px solid #ccc; border-radius: 20px; height: 400px; margin: 20px">
			<h5 style="margin-left: 43%; margin-top: 20px">인기많은 가게</h5>
			<div style="text-align: center">
				<label>
					<input type="radio" v-model="radioValues" name="rank" value="pay" @change="rank" checked />결제 많은
					순
				</label>
				<label>
					<input type="radio" v-model="radioValues" name="rank" value="book" @change="rank" />찜 많은 순
				</label>
				<label>
					<input type="radio" v-model="radioValues" name="rank" value="star" @change="rank" />별점 높은 순
				</label>
			</div>
			...
			<div>
				<div
					...
					style="width: 1600px; height: 270px; margin: 0 auto; transform: translateY(-34px)"
				/>
			</div>
		</div>
	</div>
